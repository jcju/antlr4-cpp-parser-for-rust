...
public:
  ...
  virtual void enterMacroInvocation(RustParser::MacroInvocationContext *ctx) = 0;
  ...
  virtual void enterMacroInvocationSemi(RustParser::MacroInvocationSemiContext *ctx) = 0;
  virtual void exitMacroInvocationSemi(RustParser::MacroInvocationSemiContext *ctx) = 0;

  virtual void enterMacroRulesDefinition(RustParser::MacroRulesDefinitionContext *ctx) = 0;
  virtual void exitMacroRulesDefinition(RustParser::MacroRulesDefinitionContext *ctx) = 0;
  ...
  virtual void enterMacroMatchToken(RustParser::MacroMatchTokenContext *ctx) = 0;
  ...
  virtual void enterMacroTranscriber(RustParser::MacroTranscriberContext *ctx) = 0;
  virtual void exitMacroTranscriber(RustParser::MacroTranscriberContext *ctx) = 0;
  ...
  virtual void enterFunctionQualifiers(RustParser::FunctionQualifiersContext *ctx) = 0;
  virtual void exitFunctionQualifiers(RustParser::FunctionQualifiersContext *ctx) = 0;

  virtual void enterAbi(RustParser::AbiContext *ctx) = 0;
  virtual void exitAbi(RustParser::AbiContext *ctx) = 0;

  virtual void enterFunctionParameters(RustParser::FunctionParametersContext *ctx) = 0;
  virtual void exitFunctionParameters(RustParser::FunctionParametersContext *ctx) = 0;
  ...
  virtual void enterFunctionParamPattern(RustParser::FunctionParamPatternContext *ctx) = 0;
  virtual void exitFunctionParamPattern(RustParser::FunctionParamPatternContext *ctx) = 0;

  virtual void enterFunctionReturnType(RustParser::FunctionReturnTypeContext *ctx) = 0;
  virtual void exitFunctionReturnType(RustParser::FunctionReturnTypeContext *ctx) = 0;
  ...
  virtual void enterEnumItemDiscriminant(RustParser::EnumItemDiscriminantContext *ctx) = 0;
  virtual void exitEnumItemDiscriminant(RustParser::EnumItemDiscriminantContext *ctx) = 0;
  ...
  virtual void enterWhereClauseItem(RustParser::WhereClauseItemContext *ctx) = 0;
  virtual void exitWhereClauseItem(RustParser::WhereClauseItemContext *ctx) = 0;

  virtual void enterLifetimeWhereClauseItem(RustParser::LifetimeWhereClauseItemContext *ctx) = 0;
  virtual void exitLifetimeWhereClauseItem(RustParser::LifetimeWhereClauseItemContext *ctx) = 0;

  virtual void enterTypeBoundWhereClauseItem(RustParser::TypeBoundWhereClauseItemContext *ctx) = 0;
  virtual void exitTypeBoundWhereClauseItem(RustParser::TypeBoundWhereClauseItemContext *ctx) = 0;
  ...
  virtual void enterExpressionStatement(RustParser::ExpressionStatementContext *ctx) = 0;
  virtual void exitExpressionStatement(RustParser::ExpressionStatementContext *ctx) = 0;

  virtual void enterTypeCastExpression(RustParser::TypeCastExpressionContext *ctx) = 0;
  virtual void exitTypeCastExpression(RustParser::TypeCastExpressionContext *ctx) = 0;

  virtual void enterPathExpression_(RustParser::PathExpression_Context *ctx) = 0;
  virtual void exitPathExpression_(RustParser::PathExpression_Context *ctx) = 0;

  virtual void enterTupleExpression(RustParser::TupleExpressionContext *ctx) = 0;
  virtual void exitTupleExpression(RustParser::TupleExpressionContext *ctx) = 0;

  virtual void enterIndexExpression(RustParser::IndexExpressionContext *ctx) = 0;
  virtual void exitIndexExpression(RustParser::IndexExpressionContext *ctx) = 0;

  virtual void enterRangeExpression(RustParser::RangeExpressionContext *ctx) = 0;
  virtual void exitRangeExpression(RustParser::RangeExpressionContext *ctx) = 0;

  virtual void enterMacroInvocationAsExpression(RustParser::MacroInvocationAsExpressionContext *ctx) = 0;
  virtual void exitMacroInvocationAsExpression(RustParser::MacroInvocationAsExpressionContext *ctx) = 0;

  virtual void enterReturnExpression(RustParser::ReturnExpressionContext *ctx) = 0;
  virtual void exitReturnExpression(RustParser::ReturnExpressionContext *ctx) = 0;

  virtual void enterAwaitExpression(RustParser::AwaitExpressionContext *ctx) = 0;
  virtual void exitAwaitExpression(RustParser::AwaitExpressionContext *ctx) = 0;

  virtual void enterErrorPropagationExpression(RustParser::ErrorPropagationExpressionContext *ctx) = 0;
  virtual void exitErrorPropagationExpression(RustParser::ErrorPropagationExpressionContext *ctx) = 0;

  virtual void enterContinueExpression(RustParser::ContinueExpressionContext *ctx) = 0;
  virtual void exitContinueExpression(RustParser::ContinueExpressionContext *ctx) = 0;

  virtual void enterAssignmentExpression(RustParser::AssignmentExpressionContext *ctx) = 0;
  virtual void exitAssignmentExpression(RustParser::AssignmentExpressionContext *ctx) = 0;

  virtual void enterMethodCallExpression(RustParser::MethodCallExpressionContext *ctx) = 0;
  virtual void exitMethodCallExpression(RustParser::MethodCallExpressionContext *ctx) = 0;

  virtual void enterLiteralExpression_(RustParser::LiteralExpression_Context *ctx) = 0;
  virtual void exitLiteralExpression_(RustParser::LiteralExpression_Context *ctx) = 0;

  virtual void enterStructExpression_(RustParser::StructExpression_Context *ctx) = 0;
  virtual void exitStructExpression_(RustParser::StructExpression_Context *ctx) = 0;

  virtual void enterTupleIndexingExpression(RustParser::TupleIndexingExpressionContext *ctx) = 0;
  virtual void exitTupleIndexingExpression(RustParser::TupleIndexingExpressionContext *ctx) = 0;

  virtual void enterNegationExpression(RustParser::NegationExpressionContext *ctx) = 0;
  virtual void exitNegationExpression(RustParser::NegationExpressionContext *ctx) = 0;
  ...
  virtual void enterLazyBooleanExpression(RustParser::LazyBooleanExpressionContext *ctx) = 0;
  virtual void exitLazyBooleanExpression(RustParser::LazyBooleanExpressionContext *ctx) = 0;

  virtual void enterDereferenceExpression(RustParser::DereferenceExpressionContext *ctx) = 0;
  virtual void exitDereferenceExpression(RustParser::DereferenceExpressionContext *ctx) = 0;

  virtual void enterExpressionWithBlock_(RustParser::ExpressionWithBlock_Context *ctx) = 0;
  virtual void exitExpressionWithBlock_(RustParser::ExpressionWithBlock_Context *ctx) = 0;

  virtual void enterGroupedExpression(RustParser::GroupedExpressionContext *ctx) = 0;
  virtual void exitGroupedExpression(RustParser::GroupedExpressionContext *ctx) = 0;

  virtual void enterBreakExpression(RustParser::BreakExpressionContext *ctx) = 0;
  virtual void exitBreakExpression(RustParser::BreakExpressionContext *ctx) = 0;

  virtual void enterArithmeticOrLogicalExpression(RustParser::ArithmeticOrLogicalExpressionContext *ctx) = 0;
  virtual void exitArithmeticOrLogicalExpression(RustParser::ArithmeticOrLogicalExpressionContext *ctx) = 0;

  virtual void enterFieldExpression(RustParser::FieldExpressionContext *ctx) = 0;
  virtual void exitFieldExpression(RustParser::FieldExpressionContext *ctx) = 0;

  virtual void enterEnumerationVariantExpression_(RustParser::EnumerationVariantExpression_Context *ctx) = 0;
  virtual void exitEnumerationVariantExpression_(RustParser::EnumerationVariantExpression_Context *ctx) = 0;

  virtual void enterComparisonExpression(RustParser::ComparisonExpressionContext *ctx) = 0;
  virtual void exitComparisonExpression(RustParser::ComparisonExpressionContext *ctx) = 0;

  virtual void enterAttributedExpression(RustParser::AttributedExpressionContext *ctx) = 0;
  virtual void exitAttributedExpression(RustParser::AttributedExpressionContext *ctx) = 0;

  virtual void enterBorrowExpression(RustParser::BorrowExpressionContext *ctx) = 0;
  virtual void exitBorrowExpression(RustParser::BorrowExpressionContext *ctx) = 0;

  virtual void enterCompoundAssignmentExpression(RustParser::CompoundAssignmentExpressionContext *ctx) = 0;
  virtual void exitCompoundAssignmentExpression(RustParser::CompoundAssignmentExpressionContext *ctx) = 0;

  virtual void enterClosureExpression_(RustParser::ClosureExpression_Context *ctx) = 0;
  virtual void exitClosureExpression_(RustParser::ClosureExpression_Context *ctx) = 0;

  virtual void enterArrayExpression(RustParser::ArrayExpressionContext *ctx) = 0;
  virtual void exitArrayExpression(RustParser::ArrayExpressionContext *ctx) = 0;

  virtual void enterComparisonOperator(RustParser::ComparisonOperatorContext *ctx) = 0;
  virtual void exitComparisonOperator(RustParser::ComparisonOperatorContext *ctx) = 0;

  virtual void enterCompoundAssignOperator(RustParser::CompoundAssignOperatorContext *ctx) = 0;
  virtual void exitCompoundAssignOperator(RustParser::CompoundAssignOperatorContext *ctx) = 0;

  virtual void enterExpressionWithBlock(RustParser::ExpressionWithBlockContext *ctx) = 0;
  virtual void exitExpressionWithBlock(RustParser::ExpressionWithBlockContext *ctx) = 0;

  virtual void enterLiteralExpression(RustParser::LiteralExpressionContext *ctx) = 0;
  virtual void exitLiteralExpression(RustParser::LiteralExpressionContext *ctx) = 0;
  ...
  virtual void enterBlockExpression(RustParser::BlockExpressionContext *ctx) = 0;
  ...
  virtual void enterAsyncBlockExpression(RustParser::AsyncBlockExpressionContext *ctx) = 0;
  virtual void exitAsyncBlockExpression(RustParser::AsyncBlockExpressionContext *ctx) = 0;

  virtual void enterUnsafeBlockExpression(RustParser::UnsafeBlockExpressionContext *ctx) = 0;
  virtual void exitUnsafeBlockExpression(RustParser::UnsafeBlockExpressionContext *ctx) = 0;
  ...
  virtual void enterStructExpression(RustParser::StructExpressionContext *ctx) = 0;
  virtual void exitStructExpression(RustParser::StructExpressionContext *ctx) = 0;

  virtual void enterStructExprStruct(RustParser::StructExprStructContext *ctx) = 0;
  virtual void exitStructExprStruct(RustParser::StructExprStructContext *ctx) = 0;

  virtual void enterStructExprFields(RustParser::StructExprFieldsContext *ctx) = 0;
  virtual void exitStructExprFields(RustParser::StructExprFieldsContext *ctx) = 0;

  virtual void enterStructExprField(RustParser::StructExprFieldContext *ctx) = 0;
  ...
  virtual void enterStructExprTuple(RustParser::StructExprTupleContext *ctx) = 0;
  ...
  virtual void enterEnumerationVariantExpression(RustParser::EnumerationVariantExpressionContext *ctx) = 0;
  virtual void exitEnumerationVariantExpression(RustParser::EnumerationVariantExpressionContext *ctx) = 0;
  ...
  virtual void enterEnumExprFieldless(RustParser::EnumExprFieldlessContext *ctx) = 0;
  virtual void exitEnumExprFieldless(RustParser::EnumExprFieldlessContext *ctx) = 0;
  ...
  virtual void enterClosureExpression(RustParser::ClosureExpressionContext *ctx) = 0;
  virtual void exitClosureExpression(RustParser::ClosureExpressionContext *ctx) = 0;

  virtual void enterClosureParameters(RustParser::ClosureParametersContext *ctx) = 0;
  virtual void exitClosureParameters(RustParser::ClosureParametersContext *ctx) = 0;
  ...
  virtual void enterInfiniteLoopExpression(RustParser::InfiniteLoopExpressionContext *ctx) = 0;
  virtual void exitInfiniteLoopExpression(RustParser::InfiniteLoopExpressionContext *ctx) = 0;

  virtual void enterPredicateLoopExpression(RustParser::PredicateLoopExpressionContext *ctx) = 0;
  virtual void exitPredicateLoopExpression(RustParser::PredicateLoopExpressionContext *ctx) = 0;

  virtual void enterPredicatePatternLoopExpression(RustParser::PredicatePatternLoopExpressionContext *ctx) = 0;
  virtual void exitPredicatePatternLoopExpression(RustParser::PredicatePatternLoopExpressionContext *ctx) = 0;

  virtual void enterIteratorLoopExpression(RustParser::IteratorLoopExpressionContext *ctx) = 0;
  virtual void exitIteratorLoopExpression(RustParser::IteratorLoopExpressionContext *ctx) = 0;
  ...
  virtual void enterIfLetExpression(RustParser::IfLetExpressionContext *ctx) = 0;
  virtual void exitIfLetExpression(RustParser::IfLetExpressionContext *ctx) = 0;

  virtual void enterMatchExpression(RustParser::MatchExpressionContext *ctx) = 0;
  ...
  virtual void enterMatchArmExpression(RustParser::MatchArmExpressionContext *ctx) = 0;
  virtual void exitMatchArmExpression(RustParser::MatchArmExpressionContext *ctx) = 0;
  ...
  virtual void enterPatternNoTopAlt(RustParser::PatternNoTopAltContext *ctx) = 0;
  virtual void exitPatternNoTopAlt(RustParser::PatternNoTopAltContext *ctx) = 0;

  virtual void enterPatternWithoutRange(RustParser::PatternWithoutRangeContext *ctx) = 0;
  virtual void exitPatternWithoutRange(RustParser::PatternWithoutRangeContext *ctx) = 0;
  ...
  virtual void enterIdentifierPattern(RustParser::IdentifierPatternContext *ctx) = 0;
  virtual void exitIdentifierPattern(RustParser::IdentifierPatternContext *ctx) = 0;

  virtual void enterWildcardPattern(RustParser::WildcardPatternContext *ctx) = 0;
  ...
  virtual void enterInclusiveRangePattern(RustParser::InclusiveRangePatternContext *ctx) = 0;
  virtual void exitInclusiveRangePattern(RustParser::InclusiveRangePatternContext *ctx) = 0;

  virtual void enterHalfOpenRangePattern(RustParser::HalfOpenRangePatternContext *ctx) = 0;
  virtual void exitHalfOpenRangePattern(RustParser::HalfOpenRangePatternContext *ctx) = 0;

  virtual void enterObsoleteRangePattern(RustParser::ObsoleteRangePatternContext *ctx) = 0;
  virtual void exitObsoleteRangePattern(RustParser::ObsoleteRangePatternContext *ctx) = 0;

  virtual void enterRangePatternBound(RustParser::RangePatternBoundContext *ctx) = 0;
  virtual void exitRangePatternBound(RustParser::RangePatternBoundContext *ctx) = 0;

  virtual void enterReferencePattern(RustParser::ReferencePatternContext *ctx) = 0;
  virtual void exitReferencePattern(RustParser::ReferencePatternContext *ctx) = 0;
  ...
  virtual void enterStructPatternElements(RustParser::StructPatternElementsContext *ctx) = 0;
  virtual void exitStructPatternElements(RustParser::StructPatternElementsContext *ctx) = 0;

  virtual void enterStructPatternFields(RustParser::StructPatternFieldsContext *ctx) = 0;
  virtual void exitStructPatternFields(RustParser::StructPatternFieldsContext *ctx) = 0;

  virtual void enterStructPatternField(RustParser::StructPatternFieldContext *ctx) = 0;
  virtual void exitStructPatternField(RustParser::StructPatternFieldContext *ctx) = 0;

  virtual void enterStructPatternEtCetera(RustParser::StructPatternEtCeteraContext *ctx) = 0;
  virtual void exitStructPatternEtCetera(RustParser::StructPatternEtCeteraContext *ctx) = 0;

  virtual void enterTupleStructPattern(RustParser::TupleStructPatternContext *ctx) = 0;
  virtual void exitTupleStructPattern(RustParser::TupleStructPatternContext *ctx) = 0;

  virtual void enterTupleStructItems(RustParser::TupleStructItemsContext *ctx) = 0;
  virtual void exitTupleStructItems(RustParser::TupleStructItemsContext *ctx) = 0;
  ...
  virtual void enterTuplePatternItems(RustParser::TuplePatternItemsContext *ctx) = 0;
  virtual void exitTuplePatternItems(RustParser::TuplePatternItemsContext *ctx) = 0;
  ...
  virtual void enterSlicePatternItems(RustParser::SlicePatternItemsContext *ctx) = 0;
  virtual void exitSlicePatternItems(RustParser::SlicePatternItemsContext *ctx) = 0;
  ...
  virtual void enterParenthesizedType(RustParser::ParenthesizedTypeContext *ctx) = 0;
  virtual void exitParenthesizedType(RustParser::ParenthesizedTypeContext *ctx) = 0;
  ...
  virtual void enterBareFunctionType(RustParser::BareFunctionTypeContext *ctx) = 0;
  virtual void exitBareFunctionType(RustParser::BareFunctionTypeContext *ctx) = 0;

  virtual void enterFunctionTypeQualifiers(RustParser::FunctionTypeQualifiersContext *ctx) = 0;
  virtual void exitFunctionTypeQualifiers(RustParser::FunctionTypeQualifiersContext *ctx) = 0;

  virtual void enterBareFunctionReturnType(RustParser::BareFunctionReturnTypeContext *ctx) = 0;
  virtual void exitBareFunctionReturnType(RustParser::BareFunctionReturnTypeContext *ctx) = 0;

  virtual void enterFunctionParametersMaybeNamedVariadic(RustParser::FunctionParametersMaybeNamedVariadicContext *ctx) = 0;
  virtual void exitFunctionParametersMaybeNamedVariadic(RustParser::FunctionParametersMaybeNamedVariadicContext *ctx) = 0;

  virtual void enterMaybeNamedFunctionParameters(RustParser::MaybeNamedFunctionParametersContext *ctx) = 0;
  virtual void exitMaybeNamedFunctionParameters(RustParser::MaybeNamedFunctionParametersContext *ctx) = 0;

  virtual void enterMaybeNamedParam(RustParser::MaybeNamedParamContext *ctx) = 0;
  virtual void exitMaybeNamedParam(RustParser::MaybeNamedParamContext *ctx) = 0;

  virtual void enterMaybeNamedFunctionParametersVariadic(RustParser::MaybeNamedFunctionParametersVariadicContext *ctx) = 0;
  virtual void exitMaybeNamedFunctionParametersVariadic(RustParser::MaybeNamedFunctionParametersVariadicContext *ctx) = 0;

  virtual void enterTraitObjectType(RustParser::TraitObjectTypeContext *ctx) = 0;
  virtual void exitTraitObjectType(RustParser::TraitObjectTypeContext *ctx) = 0;

  virtual void enterTraitObjectTypeOneBound(RustParser::TraitObjectTypeOneBoundContext *ctx) = 0;
  virtual void exitTraitObjectTypeOneBound(RustParser::TraitObjectTypeOneBoundContext *ctx) = 0;
  ...
  virtual void enterImplTraitTypeOneBound(RustParser::ImplTraitTypeOneBoundContext *ctx) = 0;
  virtual void exitImplTraitTypeOneBound(RustParser::ImplTraitTypeOneBoundContext *ctx) = 0;
  ...
  virtual void enterTypeParamBounds(RustParser::TypeParamBoundsContext *ctx) = 0;
  ...
  virtual void enterSimplePathSegment(RustParser::SimplePathSegmentContext *ctx) = 0;
  virtual void exitSimplePathSegment(RustParser::SimplePathSegmentContext *ctx) = 0;

  virtual void enterPathInExpression(RustParser::PathInExpressionContext *ctx) = 0;
  virtual void exitPathInExpression(RustParser::PathInExpressionContext *ctx) = 0;

  virtual void enterPathExprSegment(RustParser::PathExprSegmentContext *ctx) = 0;
  virtual void exitPathExprSegment(RustParser::PathExprSegmentContext *ctx) = 0;

  virtual void enterPathIdentSegment(RustParser::PathIdentSegmentContext *ctx) = 0;
  virtual void exitPathIdentSegment(RustParser::PathIdentSegmentContext *ctx) = 0;
  ...
  virtual void enterGenericArgsConst(RustParser::GenericArgsConstContext *ctx) = 0;
  virtual void exitGenericArgsConst(RustParser::GenericArgsConstContext *ctx) = 0;

  virtual void enterGenericArgsLifetimes(RustParser::GenericArgsLifetimesContext *ctx) = 0;
  virtual void exitGenericArgsLifetimes(RustParser::GenericArgsLifetimesContext *ctx) = 0;

  virtual void enterGenericArgsTypes(RustParser::GenericArgsTypesContext *ctx) = 0;
  virtual void exitGenericArgsTypes(RustParser::GenericArgsTypesContext *ctx) = 0;

  virtual void enterGenericArgsBindings(RustParser::GenericArgsBindingsContext *ctx) = 0;
  virtual void exitGenericArgsBindings(RustParser::GenericArgsBindingsContext *ctx) = 0;

  virtual void enterGenericArgsBinding(RustParser::GenericArgsBindingContext *ctx) = 0;
  virtual void exitGenericArgsBinding(RustParser::GenericArgsBindingContext *ctx) = 0;

  virtual void enterQualifiedPathInExpression(RustParser::QualifiedPathInExpressionContext *ctx) = 0;
  virtual void exitQualifiedPathInExpression(RustParser::QualifiedPathInExpressionContext *ctx) = 0;

  virtual void enterQualifiedPathType(RustParser::QualifiedPathTypeContext *ctx) = 0;
  virtual void exitQualifiedPathType(RustParser::QualifiedPathTypeContext *ctx) = 0;

  virtual void enterQualifiedPathInType(RustParser::QualifiedPathInTypeContext *ctx) = 0;
  virtual void exitQualifiedPathInType(RustParser::QualifiedPathInTypeContext *ctx) = 0;

  virtual void enterTypePath(RustParser::TypePathContext *ctx) = 0;
  virtual void exitTypePath(RustParser::TypePathContext *ctx) = 0;

  virtual void enterTypePathSegment(RustParser::TypePathSegmentContext *ctx) = 0;
  ...
  virtual void enterMacroIdentifierLikeToken(RustParser::MacroIdentifierLikeTokenContext *ctx) = 0;
  virtual void exitMacroIdentifierLikeToken(RustParser::MacroIdentifierLikeTokenContext *ctx) = 0;

  virtual void enterMacroLiteralToken(RustParser::MacroLiteralTokenContext *ctx) = 0;
  virtual void exitMacroLiteralToken(RustParser::MacroLiteralTokenContext *ctx) = 0;

  virtual void enterMacroPunctuationToken(RustParser::MacroPunctuationTokenContext *ctx) = 0;
  virtual void exitMacroPunctuationToken(RustParser::MacroPunctuationTokenContext *ctx) = 0;
